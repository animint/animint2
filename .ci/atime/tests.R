test.list <- atime::atime_test_list(
  ...
  "getCommonChunk improved in #238"=atime::atime_test(
    ...
    Fast="188cb3422ee0c87d9a71c06ab42a67b9dccb4be0"), # Last commit in the PR (https://github.com/animint/animint2/pull/238/commits).
  ...
  "getCommonChunk C++ #258"=atime::atime_test(
    ...
    Fast="188cb3422ee0c87d9a71c06ab42a67b9dccb4be0") # CRAN-NOTES fix on PR https://github.com/animint/animint2/pull/342
)
