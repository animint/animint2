...
If your PR does include code from AI code generation software, we ask that you declare each usage in a PR comment, for example: "lines 27-35 of file.R of this PR were generated by (SOFTWARE) using prompt (PROMPT)."
