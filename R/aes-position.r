...
#' p + a_geom_segment(aes(x = 2, y = 15, xend = 2, yend = 25),
#'   arrow = arrow(length = unit(0.5, "cm")))
#' p + a_geom_segment(aes(x = 2, y = 15, xend = 3, yend = 15),
#'   arrow = arrow(length = unit(0.5, "cm")))
#' p + a_geom_segment(aes(x = 5, y = 30, xend = 3.5, yend = 25),
#'   arrow = arrow(length = unit(0.5, "cm")))
#'
...
#'   a_geom_segment(aes(yend = 0, xend = x), size = 10)
NULL
