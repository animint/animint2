...
a_facet_render <- function(a_facet, panels_grob, coord, a_theme, geom_grobs)
  UseMethod("a_facet_render")

a_facet_strips <- function(a_facet, panel, a_theme)
  UseMethod("a_facet_strips")

a_facet_panels <- function(a_facet, panel, coord, a_theme, geom_grobs)
  UseMethod("a_facet_panels")

a_facet_axes <- function(a_facet, panel, coord, a_theme)
