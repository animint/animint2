...
a_facet_render <- function(a_facet, panels_grob, coord, theme, geom_grobs)
  UseMethod("a_facet_render")

a_facet_strips <- function(a_facet, panel, theme)
  UseMethod("a_facet_strips")

a_facet_panels <- function(a_facet, panel, coord, theme, geom_grobs)
  UseMethod("a_facet_panels")

a_facet_axes <- function(a_facet, panel, coord, theme)
