...
a_Geom <- a_ggproto("a_Geom",
  ...
  use_defaults = function(self, data, params = list()) {
    ...
    a_aes_params <- intersect(self$a_aesthetics(), names(params))
    check_aesthetics(params[a_aes_params], nrow(data))
    data[a_aes_params] <- params[a_aes_params]
    data
  },
