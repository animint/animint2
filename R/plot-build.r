#' Build a_plot for rendering.
#'
#' \code{a_plot_build} takes the plot object, and performs all steps necessary
...
#' @param data plot data generated by \code{\link{a_plot_build}}
#' @export
a_plot_gtable <- function(data) {
  plot <- data$plot
  panel <- data$panel
  data <- data$data
...
#' Generate a ggplot2 (a_plot) plot grob.
#'
#' @param x a_plot2 object
#' @keywords internal
#' @export
ggplotGrob <- function(x) {
  a_plot_gtable(a_plot_build(x))
}
