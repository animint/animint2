...
#' # a_plot(data, aes(x, y, shape = shape, colour = colour)) + geom_point()
#' #
...
#' # a_plot(data, aes(x, y)) + geom_point(method = "lm") + geom_smooth(method = "lm")
#'
#' # Scales and axes
#'
