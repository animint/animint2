...
<!-- I use this Quarto file to generate README.md, which I then use to generate the HTML for the animint2 reference homepage. -->
...
![A GIF demonstrating the capacities of an interactive data visualization. It uses fertility data from the World Bank. The user uses the selection menu and clicks on the legend, which causes changes in a couple of line graphs.](world_bank_screencast.gif)
