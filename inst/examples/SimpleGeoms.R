...
g1 <- a_plot() + a_geom_point(data=xydata, aes(x=x, y=y)) + 
  a_geom_abline(data=data.frame(intercept=c(3, 0), slope=c(2,1)), aes(intercept=intercept, slope=slope)) +
...
g3 <- a_plot() + a_geom_density(data=boxplotdata, aes(x=y, group=group, fill=group), alpha=.5) +
...
g4 <- a_plot() + a_geom_tile(data=tiledata, aes(x=rx, y=ry, fill=n)) +
...
# g7 <- a_plot() + 
#   a_geom_boxplot(data=boxplotdata, aes(y=y, x=factor(group))) +
#   ggtitle("a_geom_boxplot")
# g7
# gg2animint(list(g1=g1, g2=g2, g3=g3, g4=g4, g5=g5, g6=g6, g7=g7))

g7 <- a_plot() + 
  a_geom_linerange(data=boxplotdata, aes(x=factor(group), ymax=ymax, ymin=ymin, colour=factor(group))) +
  ggtitle("a_geom_linerange") + a_scale_colour_discrete("Distribution") + xlab("Distribution")
g7
# gg2animint(list(g1=g1, g2=g2, g3=g3, g4=g4, g5=g5, g6=g6, g7=g7))

g8 <- a_plot() + 
  a_geom_histogram(data=subset(boxplotdata, group=="Gamma(2,1/3)"), aes(x=y, fill=..count..), binwidth=1) + 
  ggtitle("a_geom_histogram")
g8
# gg2animint(list(g1=g1, g2=g2, g3=g3, g4=g4, g5=g5, g6=g6, g7=g7, g8=g8))

g9 <- a_plot() + 
  a_geom_violin(data=boxplotdata, aes(x=group, y=y, fill=group, group=group)) +
...
g10 <- a_plot() + a_geom_step(data=boxplotdata, aes(x=x, y=y, colour=factor(group), group=group)) +
...
g11 <- a_plot() + a_geom_contour(data=contourdata, aes(x=x, y=y, z=z), binwidth=4, size=0.5) + 
  a_geom_contour(data=contourdata, aes(x=x, y=y, z=z), binwidth=10, size=1) +
...
g13 <- a_plot() +  
  ...
  a_geom_contour(data=geyser, aes(x = duration, y = waiting), colour="blue", size=.5, a_stat="density2d") + 
...
g14 <- a_plot() +  
  a_geom_polygon(data=geyser,aes(x=duration, y=waiting, fill=..level.., 
                               group=..piece..), 
...
g15 <- a_plot() + 
  a_geom_tile(data=dsmall, aes(x=carat, y=price, fill=..density.., colour=..density..), a_stat="density2d", contour=FALSE, n=30) +
...
g16 <- a_plot() + 
  a_geom_point(data=dsmall, aes(x=carat, y=price, alpha=..density..), 
...
#' a_geom_bar stacked
data(mtcars)
g18 <- a_plot() + a_geom_bar(data=mtcars, aes(x=factor(cyl), fill=factor(vs))) + ggtitle("a_geom_bar stacked")
g18
# gg2animint(list(g1=g1, g2=g2, g3=g3, g4=g4, g5=g5, g6=g6, g7=g7, g8=g8, 
#                 g9=g9, g10=g10, g11=g11, g12=g12, g13=g13, g14=g14, g15=g15, 
...
data(diamonds)
g19 <- a_plot() + 
  a_geom_area(data=diamonds, aes(x=clarity, y=..count.., group=cut, colour=cut, fill=cut), a_stat="density") +
  ggtitle("a_geom_area")
g19
# gg2animint(list(g1=g1, g2=g2, g3=g3, g4=g4, g5=g5, g6=g6, g7=g7, g8=g8, 
#                 g9=g9, g10=g10, g11=g11, g12=g12, g13=g13, g14=g14, g15=g15, 
...
g20 <- a_plot() + 
  a_geom_freqpoly(data=diamonds, aes(x=clarity, group=cut, colour=cut)) +
...
g21 <- a_plot() + 
  a_geom_hex(data=dsmall, aes(x=carat, y=price)) +
  a_scale_fill_gradient(low="#56B1F7", high="#132B43") + 
