        ...
        i
          ? 1 === i
            ...
            : function (a, c) {
                var d, e, f;
                for (d = 0; i > d; d++)
                  if (((f = h[d].field), (e = k[d] * b(l(f, a), l(f, c)))))
                    return e;
                return 0;
              }
          : null
    ...
    h = (function () {
      ...
      for (c in g)
        if (g.hasOwnProperty(c))
          for (
            d = g[c].substring(2, g[c].length - 1), e += d, a = 0, b = d.length;
            b > a;
            a++
          )
            f[d.charAt(a)] = c;
        ...
        if (
          ...
          a.extend(i, {
            ...
            onSearchChange:
              null === d.loadThrottle
                ? i.onSearchChange
                : E(i.onSearchChange, d.loadThrottle),
          }),
    ...
    return (
      ...
      a.extend(L.prototype, {
          ...
          for (
            ...
            (l = i[c]),
              t.optgroups.hasOwnProperty(l) && h[l].length
                ? ((o = t.render('optgroup_header', t.optgroups[l]) || ''),
                  (o += h[l].join('')),
                  n.push(
                    t.render(
                      'optgroup',
                      a.extend({}, t.optgroups[l], { html: o })
                    )
                  ))
                : n.push(h[l].join(''));
          if (
            ...
            for (c = 0, g = v.tokens.length; g > c; c++)
              d(w, v.tokens[c].regex);
          if (!t.settings.hideSelected)
            for (c = 0, g = t.items.length; g > c; c++)
        ...
        registerOption: function (a) {
          ...
          return !b || this.options.hasOwnProperty(b)
            ? !1
        ...
        removeItem: function (a, b) {
          ...
          (c = 'object' == typeof a ? a : f.getItem(a)),
            ...
            -1 !== d &&
              (c.remove(),
              c.hasClass('active') &&
                ((e = f.$activeItems.indexOf(c[0])),
                f.$activeItems.splice(e, 1)),
              f.items.splice(d, 1),
              (f.lastQuery = null),
              !f.settings.persist &&
                f.userOptions.hasOwnProperty(a) &&
                f.removeOption(a, b),
              d < f.caretPos && f.setCaret(f.caretPos - 1),
              f.refreshState(),
              f.updatePlaceholder(),
              f.updateOriginalInput({ silent: b }),
              f.positionDropdown(),
        ...
        render: function (a, b) {
          ...
          return (
            ('option' === a || 'item' === a) &&
              ((c = z(b[g.settings.valueField])), (f = !!c)),
            f &&
            (y(g.renderCache[a]) || (g.renderCache[a] = {}),
            g.renderCache[a].hasOwnProperty(c))
              ? g.renderCache[a][c]
              : ((e = g.settings.render[a].apply(this, [b, A])),
                ('option' === a || 'option_create' === a) &&
                  (e = e.replace(h, '<$1 data-selectable')),
                'optgroup' === a &&
                  ((d = b[g.settings.optgroupValueField] || ''),
                  (e = e.replace(h, '<$1 data-group="' + B(A(d)) + '"'))),
                ('option' === a || 'item' === a) &&
                  (e = e.replace(h, '<$1 data-value="' + B(A(c || '')) + '"')),
        ...
        var c = a.fn.selectize.defaults,
          ...
          k = function (b, c) {
            ...
            if (l)
              ...
              for (j = m.split(d.delimiter), h = 0, i = j.length; i > h; h++)
      ...
      L.define('optgroup_columns', function (b) {
        ...
        (b.equalizeHeight || b.equalizeWidth) &&
          (C.after(this, 'positionDropdown', e),
