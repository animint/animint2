...
<ol class="annotated">
	<li><span class="explanation">I begin with the dataset, called `meowtrics`.</span>
	<li><span class="explanation">I pipe it into `ggplot()`, which tells `animint2` that I'm creating a data visualization.</span>
