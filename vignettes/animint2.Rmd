...
And that's it. You're now a competent `animint2` user. Your certificate of completion will arrive by post within four to five business days.^[The certificate of completion is both invisible and intangible. Some philosophers posit that this certificate may not exist at all.]
