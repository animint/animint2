...
```{r anatomy-cute-plot-2, fig.alt = "A scatterplot titled Cat Cutness Ratings Over Time. It looks exactly the same as the previous graph, except all the data points are differentiated by color. There's also a legend that maps each color to a cat.}
cute_plot_2 <-                                   #1
  ggplot() +
  geom_point(
    data = meowtrics,
