...
<!-- This loads Popper, a js package that lets footnotes work in pkgdown. Yeah, I know. I also dislike it. -->
...
[^4]: It's possible to differentiate the data points in a different manner. For example, instead of different colors, I could have used different shapes.
