...
Are you a Firefox user? Then this message is for you. Also, congrats on using the best browser.

`animint2` and Firefox [interact strangely](https://github.com/animint/animint2/issues/90). Some animints seem to cause the webpage to scroll up by itself. Two practical solutions are:

1. To click the "Hide selection menus" button if you see it present; or
2. To click the "Show animation control" button and hit pause.
